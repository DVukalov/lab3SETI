...
QT_MOC_LITERAL(1, 10, 3), // "FTP"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4) // "HTTP"

    },
    "Interface\0FTP\0\0HTTP"
};
...
void Interface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Interface::FTP)) {
                *result = 0;
            }
        }
        {
            typedef void (Interface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Interface::HTTP)) {
                *result = 1;
            }
        }
    }
